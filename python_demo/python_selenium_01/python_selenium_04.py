...
# # 鼠标事件实战
#
# # # 定位鼠标移动到上面的元素。/chrome可以执行。firefox会报错，百度说因为Firefox版本太高，48的版本。
...
# # driver.find_element_by_css_selector("#app > div > div.header > div.main > div.login > div > div.mobienum > input[type=text]").send_keys("16621103980")
# # driver.find_element_by_css_selector("#app > div > div.header > div.main > div.login > div > div.psw > input[type=password]").clear()
# # driver.find_element_by_css_selector("#app > div > div.header > div.main > div.login > div > div.psw > input[type=password]").send_keys("123456789")
# #
